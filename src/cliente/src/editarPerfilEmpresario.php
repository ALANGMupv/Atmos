...
<head>
    ...
    <script type="module" src="js/editar_perfil_empresario.js" defer></script>
</head>

<body>

<?php include __DIR__ . '/partials/headerEmpresas.php'; ?>
...
<main class="ep-main-container">
    ...
    <section class="ep-container">
        ...
        <!-- Flecha hacia atrás -->
        <a href="perfilEmpresario.php" class="ep-back-btn">
