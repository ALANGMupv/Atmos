...
<body>
                        ...
                        <div class="card-body">
                            <div class="action-panel">
                                ...
                                <div class="action-controls">
                                    <button type="button" class="btn-action btn-resolve" id="btnResolve">
                                        <i class="fa-solid fa-check"></i> Resolver
                                    </button>
                                    <button type="button" class="btn-action btn-reject" id="btnReject">
    ...
    <script>
        // Este script solo maneja la selección de incidencias (la lógica de envío está en adminIncidencias.js)
