            ...
            <div class="left-container">
                ...
                <div class="menu-container">
                    ...
                    <div class="botones-menu-container">
                        <button class="menu-btn" onclick="window.open('/manual/Manual_de_usuario_Atmos.pdf', '_blank')"><img src="img/manualUsuarioBoton.svg" alt=""></button>
                    ...
                    <div class="selector-recorrido-container">
                        ...
                        <div class="recorrido-container">
                            <div class="recorrido-info">
                                <p class="recorrido-hoy"><strong>Distancia recorrida hoy:</strong> <span id="distanciaHoy">100 m</span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-miSensor-mobile">
                        ...
                        <div class="distancia_estado-container">
                            <div class="estado-container">
                                ...
                                <img class="estado-icono" id="estadoSensorIcono"
                                     src="img/estadoActivoSensorIcono.svg" alt="">
                            ...
                            <div class="distancia-container">
                                ...
                                <img class="distancia-icono" id="iconoSenal" src="img/sinSeñalDistanciaIcono.svg"
                                     alt="">
            ...
            <div class="popup-container">
                ...
                <div class="top-containers">
                    <div class="estado-info-container">
                        ...
                        <p>Muestra el estado actual del nodo sensor. Este puede estar conectado y activo o
                            desconectado e inactivo.</p>
                    </div>

                    <div class="distancia-info-container">
                        <h2>Distancia del Sensor</h2>
                        <img src="img/distanciaSensorInfoPopup.svg" alt="">
                        <p>Indica la intensidad de la señal entre tu móvil y el sensor Atmos midiendo la potencia de
                            la señal.  Una señal alta significa que el sensor está cerca o bien conectado; una señal
                            baja puede indicar más distancia o interferencias.</p>
                    </div>
                </div>
                ...
                <div class="bottom-containers">
                    <div class="medicion-info-container">
                        ...
                        <p>Es la medición más reciente captada por tu sensor. Este valor se actualiza periódicamente
                            y permite saber en tiempo real cómo está la calidad del aire justo ahora.</p>
                    </div>

                    <div class="promedio-info-container">
                        <h2>Promedio del día</h2>
                        <img src="img/promedioInfoPopup.svg" alt="">
                        <p>Es el valor medio de las mediciones registradas por el sensor a lo largo del día. Ayuda a
                            entender cómo ha sido la calidad del aire durante la jornada, más allá de picos
                            puntuales.</p>
                    </div>
                </div>
            </div>
