 ...
 * @date 16/11/2025
 * @brief Lógica de edición de perfil de usuario.
 *
 * Este script se encarga de:
 * 1. Gestionar la apertura y cierre de popups (cambio de contraseña y confirmación).
 * 2. Alternar la visibilidad de campos de contraseña mediante iconos de ojo.
 * 3. Validar la contraseña del usuario usando Firebase antes de permitir cambios.
 * 4. Enviar los datos actualizados al backend autenticado.
 */
...
/** Contenedor del popup de cambio de contraseña */
const popupPass = document.getElementById("popup-pass");

/** Botón cancelar dentro del popup de cambio de contraseña */
...
/**
 * @brief Cierra el popup de confirmación y limpia el campo contraseña.
 */
 ...
 *
 * Usa el atributo data-target del icono para localizar el input asociado.
 */
...
// ==========================================================
// VALIDACIÓN Y CONFIRMACIÓN DE CAMBIOS CON FIREBASE
// ==========================================================

/**
 * @brief Inicialización de Firebase.
 *
 * Se unifican los imports de firebase-auth para evitar errores
 * en la carga de módulos ES.
 */
...
/**
 * @brief Activa la persistencia de sesión del usuario.
 */
...
// ==========================================================
// CONFIRMACIÓN DE CAMBIOS Y ENVÍO AL BACKEND
// ==========================================================
    ...
    popupConfirmBtn.addEventListener("click", async () => {
        ...
        try {
            ...
            if (resp.ok) {
                ...
                window.location.href = "perfilEmpresario.php";
