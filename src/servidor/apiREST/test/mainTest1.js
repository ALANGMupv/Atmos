 ...
 *
 *   Se requiere un token Firebase válido para que el middleware verificarToken
 *   permita el acceso al endpoint.
 *
 * @date 2025-12-01
...
describe("Test POST /usuario", function () {
   ...
   * @brief Comprueba que el endpoint responde 409 cuando el usuario ya existe.
   *
   * @details
   *   Cuerpo enviado:
   *      {
